      ...
      <Sidebar.Items>
        ...
        {currentUser.isAdmin && (
            <Link to="/dashboard?tab=dash">
              <Sidebar.Item
                active={tab === "dash" || !tab} // when there is no tab then we alse come to this page
                icon={HiChartPie}
                as="div"
              >
                DashBoard
          ...
          <Link to="/dashboard?tab=profile">
            ...
            <Sidebar.Item
              ...
              as="div"
            >
              {/* We can not make anchor tag inside an another anchor tag which Link here so that's way we saved it as button */}
              Profile
            </Sidebar.Item>
          </Link>
          {currentUser.isAdmin && (
