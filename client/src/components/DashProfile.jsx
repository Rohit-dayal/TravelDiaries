...
export default function DashProfile() {
  ...
  const [showModal, setShowModal] = useState(false); // for delete functionality
  ...
  const handleSubmit = async (e) => {
    ...
    if (imageUploading) {
      setUpdateUserError("Please wait for user image to upload");
      return;
    }
    try {
  ...
  return (
    <div className="max-w-lg-auto p-3 w-full">
      ...
      <Modal // for delete functionality
        show={showModal}
